...
config.General.requestName = "jet_HLT_emulation"
...
config.Data.inputDataset = "/MinBias_Drum5F_5p36TeV_hydjet/HINPbPbSpring23Digi-NoPUKeepDigiRaw_130X_mcRun3_2023_realistic_HI_v14-v1/GEN-SIM-DIGI-RAW-HLTDEBUG"
...
config.Data.outLFNDirBase = '/store/user/cbennett/%s' % (config.General.requestName)
